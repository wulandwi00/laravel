        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <img src="{{ asset('img/8.jpg') }}" alt="" style="height: 350px; width: 250px;" >
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 desc">
                    ...
                    <h3>Pantai Ora</h3>
                    <p>Pantai ora juga bisa menikmati keindahan sunset dan sunrisenya yang begitu memukau bagi banyak orang,fenomena tersebut terjadi pada saat pagi dan sore menjelang malam hari.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 desc">
                    <h2>Kegiatan</h2>
                    <h3>Snorkeling</h3>
                    <p>kegiatan lain nya yang bisa dilakukan di pantai ora yaitu dengan menjelajah keindahan alam bawah lautnya, lokasi snorkeling yang berjarak sekitar 15 menit dari Pantai Ora dengan menggunakan perahu motor kecil,kita akan menemukan keindahan alam bawah laut yang sangat memukai. Hamparan koral warna-warni nan indah dan berbagai ragam ikan-ikan cantik penuh warna. Sungguh sebuah pemandangan yang luar biasa mengagumkan</p>
                    </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <img src="{{ asset('img/11.jpg') }}" alt="" style="height: 350px; width: 250px;" >
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <img src="{{ asset('img/16.jpg') }}" alt="" style="height: 350px; width: 250px;" >
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 desc">
                    <h2>Kegiatan</h2>
                    <h3>Menjelajah Goa</h3>
                    <p>Bukan hanya keindahan air pantai saja, para pengunjung yang tertarik dengan jelajah alam, bisa menikmati petualang menjelajahi goa di Pantai Ora ini. Bagi penyuka aktivitas outdoor, tentu hal ini akan sangat menggembirakan. Namun untuk alasan keamanan, sebaiknya para mengajak pemandu lokal biar tidak tersesat.</p>
                </div>
            </div>
        </div>
    </section>
